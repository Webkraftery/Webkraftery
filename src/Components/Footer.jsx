...
const Footer = () => {
  return (
    <footer className="noto-serif z-50 bg-gray-800 text-gray-300 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
        ...
        <div className="mb-0">
          ...
          <p className="text-gray-400 leading-relaxed text-sm">
            Your trusted partner for innovative web solutions — driving digital
            transformation, boosting online success, and delivering lasting
            impact. We design, optimize, and maintain powerful digital
        ...
        <div>
          ...
          <address className="not-italic text-gray-400 space-y-2 text-sm">
            ...
            <p>
              Phone:{" "}
              <a href="tel:+918882320645" className="hover:text-white">
                +91 8882320645
              </a>
            </p>
            <p>
              Phone:{" "}
              <a href="tel:+918936950459" className="hover:text-white">
                +91 8936950459
              </a>
            </p>
          </address>
      ...
      {/* Copyright */}
      <div className="border-t border-gray-700 mt-2 md:mt-10 pt-4 md:pt-8 text-center text-gray-500 text-sm">
        <p>
          &copy; {new Date().getFullYear()} WebKraftery. All rights reserved. |{" "}
          <a href="/company/aboutcompany" className="hover:text-white">
            Privacy Policy
          </a>{" "}
          |{" "}
          <a href="/company/aboutcompany" className="hover:text-white">
